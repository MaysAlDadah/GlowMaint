...
$package  = check_input(   $_POST['[package]']      );
...
<section class="our-team">
    ...
    <div class="container">
       ...
       <div class="layer"> 
         ...
         <div class="mb-3">
        <label for="" style="color: red;">Service Evaluation</label>
        <input type="text" placeholder=" Service Evaluation ..." name="Service" class="form-control ">
        </div>
        <button class="btn btn-success px-5" style="cursor: pointer;">Save</button>
   ...
   <div class="content" data-aos="fade-left">
    ...
    <div class="login1" >
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="success">
        <i class="fa-solid fa-check"></i>data stored successful
        </div> 
        <?php }?>
       ...
       <input class="input-filed" type="text" name="package"  value="<?=$package?>">
       <label> location</label>
       <input class="input-filed" type="text"  name="location"  value="<?=$location?>">
